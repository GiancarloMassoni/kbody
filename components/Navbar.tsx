...
export default function Navbar() {
  ...
  return (
    <header className="absolute inset-x-0 top-0 z-5 bg-secondary">
      <nav
        aria-label="Global"
      ...
      >
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            ...
            <Image alt="" src={kbLogo} className="h-8 w-auto" />
          </Link>
        </div>
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          {navigation.map((item) => (
            <Link
              key={item.name}
              href={item.href}
              className="text-sm/6  text-textPrimary font-body"
            >
              {item.name}
            </Link>
          ))}
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link
            href="https://www.instagram.com/kaitlinbrubakerr/"
            target="_blank"
